import { useLocalization, useShopQuery, Seo, Image, CacheLong, type HydrogenRouteProps } from '@shopify/hydrogen';
...
import { ARTICLE_QUERY } from './query';
...
export default function Post({ params, response }: HydrogenRouteProps) {
    ...
    const formattedDate = new Intl.DateTimeFormat(`${languageCode}-${countryCode}`, {
        year: 'numeric',
        month: 'long',
        day: 'numeric',
