...
export function AccountActivateForm({ id, activationToken }: { id: string; activationToken: string }) {
    ...
    const [passwordConfirmError, setPasswordConfirmError] = useState<null | string>(null);

    function passwordValidation(form: HTMLFormElement & { password: HTMLInputElement }) {
    ...
    async function onSubmit(event: React.FormEvent<HTMLFormElement & { password: HTMLInputElement }>) {
            ...
            <div className="w-full max-w-md">
                ...
                <form noValidate className="pt-6 pb-8 mt-4 mb-4" onSubmit={onSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        />
                        <p className={`text-red-500 text-xs ${!passwordError ? 'invisible' : ''}`}>
                            {passwordError} &nbsp;
                        </p>
                    </div>
                    <div className="mb-4">
                        ...
                        />
                        <p className={`text-red-500 text-xs ${!passwordConfirmError ? 'invisible' : ''}`}>
