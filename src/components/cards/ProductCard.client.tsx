...
import { flattenConnection, Image, Link, Money, useMoney } from '@shopify/hydrogen';
...
export function ProductCard({
    ...
    } = flattenConnection<ProductVariant>(cardData?.variants as ProductVariantConnection)[0] || {};
