...
import { Link, useCart, CartLineProvider, CartShopPayButton, Money } from '@shopify/hydrogen';

import { Button, Text, CartLineItem, CartEmpty } from '..';
...
export function CartDetails({ layout, onClose }: { layout: 'drawer' | 'page'; onClose?: () => void }) {
    const { lines } = useCart();
