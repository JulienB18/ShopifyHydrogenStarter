...
import { startHydrogenServer, type HydrogenServer, type HydrogenSession } from '../utils';
...
describe('products', () => {
    ...
    it('can be added to cart', async () => {
        ...
        await Promise.all([
            session.page.waitForResponse('https://cdn.shopify.com/shopifycloud/shop-js/v1.0/client.js'),
        ...
        const [cartResponse] = await Promise.all([
            session.page.waitForResponse((response: PlaywrightResponse) => /graphql\.json/.test(response.url())),
